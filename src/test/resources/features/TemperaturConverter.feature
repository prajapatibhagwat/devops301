...
Feature: I want to convert the given centigrade temperature value into Fahrenheit value through a standard java program and an online converter applications
...
@mail
Scenario: Centigrade to Fahrenheit Converter through Application
	Given lanuch "http://automationpractice.com/index.php" Application
	Then click on link
